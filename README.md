...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/globe-visitor-visual)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/globe-visitor-visual
```

A live public deployment of this template is available at [https://globe-visitor-visual.templates.workers.dev](https://globe-visitor-visual.templates.workers.dev)
